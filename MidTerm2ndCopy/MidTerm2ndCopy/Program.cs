        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                while (line != null) // looping through the customer info text doc while string line is not empty 
                {
                    ...
                    TimeSpan daysRentedEquation = returnDate - DueDate;
                    double dayDiff = daysRentedEquation.Days;
                    double quotient = dayDiff * lateFee;
                    ...
                    if (DueDate < returnDate)// compare due date to a return date 
                    {
                        ...
                        buildFee.AppendLine(line + "late fee is: " + quotient + returnDate);
